...
describe('Atendimentos', () => {
    ...
    context('Validação de preços para cliente vinculado a categoria de cliente - Tabela sem desconto', () => {
        const prod = require("../fixtures/produtos.json")
        const precoantigo = '52,98'


        it(`Validação de precedência de preços - Cliente com categoria sem desconto`, () => {
        ...
        it(`Validação de precedência de preços - Cliente sem categoria sem desconto`, () => {
    ...
    context('Validação de preços tabela de preço configurada com desconto', () => {
        ...
        it(`Validação de preço informando diferença como desconto`, () => {
            checkout.alterarCliente('ADEMIR MOREIRA')
    ...
    context('Validação de descontos no atendimento', () => {
        const prod = require("../fixtures/produtos.json")
        const precoantigo = '52,98'
