...
public class BancoDadosERP {
	...
	public String pesquisarRecebimento() {
		...
		try {
			...
			String SQL_select_entrada = "SELECT NUMINTERNO FROM QA_COMPRAS.ENTRADAPEDIDOCOMPRA " + "INNER JOIN QA_COMPRAS.ENTRADAPEDCOMPRA_PEDCOMPRA "
					...
					+ "ON QA_COMPRAS.ENTRADAPEDCOMPRA_PEDCOMPRA.PEDIDOCOMPRA_ID  = QA_COMPRAS.PEDIDOCOMPRA.ID " + "WHERE NUMERODOCUMENTO = '3720'";
